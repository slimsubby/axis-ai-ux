...
- **Microsoft, [Guidelines for Human-AI Interaction](https://www.microsoft.com/en-us/haxtoolkit/ai-guidelines/)** (Amershi et al., CHI 2019): the 18 guidelines, cited here as G1 to G18.
...
The site is a fully static export (Next.js `output: "export"`), so no server, database, or API keys are required.
